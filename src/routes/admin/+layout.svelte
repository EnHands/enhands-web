...
<div class="flex h-screen bg-gray-100 font-sans">
    ...
    <aside class="w-64 bg-gray-900 text-blue-700 flex flex-col justify-between">
        <div>
            ...
            <nav class="p-4 space-y-2">
                <a href="/admin/blog" class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-800 transition-colors">Blog Posts</a>
                
                {#if data.user.role === 'admin'}
                    <a href="/admin/members" class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-800 transition-colors">Members</a>
                    <a href="/admin/partners" class="block px-4 py-2 rounded-md font-semibold hover:bg-gray-800 transition-colors">Partners</a>
                {/if}
            </nav>
        </div>
        ...
        <div class="p-4 border-t border-gray-800 bg-gray-950">
            <div class="mb-3">
                <p class="text-sm font-medium text-white">{data.user.name}</p>
